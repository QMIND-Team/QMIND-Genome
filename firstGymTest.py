...
# if it says keras is unused that's because i'm not sure if we actually need to write import
# keras above the from keras.models... stuff
import keras
from keras.models import Sequential
from keras.layers import Dense

# i didn't do anything with the LR (learning rate), so dont go looking for it
LR = 1e-3
...
# i dont do anything with this. its just a neural network
def neural_network():
